...
This web app: **Displays random dog images**
...
<img src='P4_wlkthrgh.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with LICEcap  

## Notes

Did not successfully retrieve data attribute(s) from api.
## License
